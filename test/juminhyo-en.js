        ...
        describe("Perfect reply and user selects LINE Pay", function(){
            it("will reserve payment and provide payment url.", function(){
                ...
                return emu.clear_context(user_id).then(function(){
                    ...
                    context.previous.message[0].message.text.should.equal("We have completed accepting applications for resident cards. We will send you a resident card at your home as soon as payment of the fee is completed.");
                });
            });
        });
    });
